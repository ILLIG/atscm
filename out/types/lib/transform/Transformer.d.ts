...
export default class Transformer {
     ...
     * transformers decide.
     */
    readNodeFile(node: FileNode): boolean | null;
    /**
     ...
     */
    transformFromDB(node: BrowsedNode, context: any): Promise<void>;
    /**
     * **Must be overridden by all subclasses:** Transforms the given node when using
     ...
     */
    transformFromFilesystem(node: BrowsedNode, context: any): Promise<void>;
    /**
    ...
    compatTransform(direction: {
        FromDB: string;
        FromFilesystem: string;
    }, node: Node, context: any): Promise<any>;
}
