...
export default class XMLTransformer extends SplittingTransformer {
     ...
     */
    constructor({ sortXMLAttributes, removeBuilderRefs, ...options }?: any);
    /** @protected */
    protected sortXMLAttributes: any;
    /** @protected */
    protected removeBuilderRefs: any;
    /**
     * The builder to use with direction {@link TransformDirection.FromDB}.
     * @type {function(object: Object): string}
     */
    _fromDBBuilder: (arg0: object) => any;
    /**
     * The builder to use with direction {@link TransformDirection.FromFilesystem}.
     * @type {function(object: Object): string}
     */
    _fromFilesystemBuilder: (arg0: object) => any;
    /**
     * @protected
     * @param {import('modify-xml').Element} node The node to handle.
     */
    protected sortedAttributeValues(node: import("modify-xml").Element): import("modify-xml").AttributeValues;
    /**
     ...
     */
    decodeContents(node: BrowsedNode): import("modify-xml").Document;
    /**
