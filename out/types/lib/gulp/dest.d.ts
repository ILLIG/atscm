...
export class WriteStream extends Writable {
     ...
     */
    _parentHasIdConflict(node: ServerNode): boolean;
     ...
     */
    _writeNode(node: ServerNode): Promise<boolean>;
    /**
     ...
     */
    _write(node: Node, enc: string, callback: any): void;
     ...
     */
    _writev(nodes: Node[], callback: any): void;
    /**
     * Destroys the stream.
