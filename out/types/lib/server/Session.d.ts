...
export default class Session {
     ...
     */
    static _close(session: any): Promise<node>;
    /**
     ...
     * rejected with the error that occured while closing.
     */
    static close(session: any): Promise<node>;
    /**
     ...
     */
    static closeOpen(): Promise<Error, Session[]>;
}
