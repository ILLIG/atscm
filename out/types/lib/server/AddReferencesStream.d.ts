...
export default class AddReferencesStream {
     ...
     */
    scriptParameters(file: AtviseFile): any;
    /**
     ...
     */
    handleOutputArguments(file: AtviseFile, outArgs: any, callback: any): void;
}
