...
export class WatchTask {
     ...
     */
    _waitForWatcher(watcher: any): Promise<events>;
    /**
     ...
     * rejected with the error that occurred while starting the watcher.
     */
    startServerWatcher(): Promise<Watcher, Error>;
    /**
