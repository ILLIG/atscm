...
exports.default = exports.ExtensionForDataType = exports.DataTypeForExtension = void 0;
var _fs = require("fs");
 ...
 * @type {NodeId}
 */
const PropertyTypeDefinition = new _NodeId.default(_NodeId.default.NodeIdType.NUMERIC, 68, 0);
...
const toRawValue = {
  ...
  [_variant.DataType.DataValue]: value => {
    ...
    mapPropertyAs(toRawValue, options, 'statusCode', _variant.DataType.StatusCode);
...
class AtviseFile extends _vinyl.default {
  ...
  _getMetadata() {
    ...
    this._nodeClass = _nodeclass.NodeClass.Variable;
